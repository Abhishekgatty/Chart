...
function Chatbot() {
    ...
    // Add a state to track the current subscription plan
    const [currentPlan, setCurrentPlan] = useState('Free'); // Default to "Free"

    // Simulate fetching the current plan (e.g., from an API or local storage)
    useEffect(() => {
        // Replace this with actual logic to fetch the user's plan
        const userPlan = localStorage.getItem('userPlan') || 'Free'; // Example: Fetch from localStorage
                            ...
                            <Col as="li" xs="6">
                                ...
                                {currentPlan === 'Free' ? (
                                    ...
                                    <Button
                                        ...
                                        disabled // Optionally disable the button for premium members
                                    >
                                        <PersonUp />
                ...
                <div className="tyn-chat-form border-0 ps-3 pe-4 py-3 bg-white mb-4 mx-4 rounded-3">
                    <div className="tyn-chat-form-enter">
                        ...
                        <ul className="tyn-list-inline me-n2 my-1">
                            <li>
                                <Button variant="white" size="md" className="btn-icon btn-pill">
                                    <SendFill />
                                </Button>
                            </li>
                        </ul>
